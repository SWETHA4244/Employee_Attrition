...
#Function to get user imput for prediction

st.sidebar.header("Employee Details")

def get_user_input():
    inputs={}
    inputs['Age']=st.sidebar.number_input("Age",min_value=18,max_value=65,value=38)
    inputs['MonthlyIncome']=st.sidebar.number_input("MontlyIncome",min_value=1000,max_value=20000,value=5000)
...
if st.button("Predict Attribution"):
    ...
    st.info(f"Prediction Probability:{probability[0][1]:.2f}") 
